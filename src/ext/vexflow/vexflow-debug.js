/**
 * VexFlow 1.2.50 built on 2016-07-02.
  ...
  */
  ...
  function drawBoldDoubleLine(ctx, type, topX, topY, botY) {
    if (type !== StaveConnector.type.BOLD_DOUBLE_LEFT && type !== StaveConnector.type.BOLD_DOUBLE_RIGHT) {
      throw Vex$1.RERR("InvalidConnector", "A REPEAT_BEGIN or REPEAT_END type must be provided.");
    }
  ...
  var StaveConnector = function () {
    ...
    createClass(StaveConnector, [{
      ...
      value: function setType(type) {
        if (type >= StaveConnector.type.SINGLE_RIGHT && type <= StaveConnector.type.NONE) this.type = type;
        return this;
      }
    }, {
      key: 'setText',
      ...
      key: 'draw',
      value: function draw() {
        if (!this.ctx) throw new Vex$1.RERR("NoContext", "Can't draw without a context.");
  ...
  var StringNumber = function (_Modifier) {
    ...
    createClass(StringNumber, [{
      ...
      value: function setLineEndType(leg) {
        if (leg >= Renderer.LineEndType.NONE && leg <= Renderer.LineEndType.DOWN) this.leg = leg;
        return this;
      }
    }, {
      key: 'getPosition',
      ...
      value: function draw() {
        ...
        if (this.last_note != null) {
          ...
          ctx.lineCap = "round";
          ctx.lineWidth = 0.6;
          if (this.dashed) Renderer.drawDashedLine(ctx, dot_x + 10, dot_y, dot_x + end, dot_y, [3, 3]);else Renderer.drawDashedLine(ctx, dot_x + 10, dot_y, dot_x + end, dot_y, [3, 0]);
  ...
  var Vibrato = function (_Modifier) {
    ...
    createClass(Vibrato, [{
      ...
      key: 'draw',
      value: function draw() {
        if (!this.context) throw new Vex$1.RERR("NoContext", "Can't draw vibrato without a context.");
        if (!this.note) throw new Vex$1.RERR("NoNoteForVibrato", "Can't draw vibrato without an attached note.");
  ...
  function L$12() {
    if (Clef.DEBUG) Vex$1.L("Vex.Flow.Clef", arguments);
  }
  ...
  var Stave = function () {
    ...
    createClass(Stave, [{
      ...
      value: function getModifierXShift(index) {
        if (typeof index !== 'number') new Vex$1.RERR("InvalidIndex", "Must be of number type");
      ...
      value: function setBegBarType(type) {
        ...
        if (type == Barline.type.SINGLE || type == Barline.type.REPEAT_BEGIN || type == Barline.type.NONE) {
      ...
      key: 'draw',
      value: function draw() {
        if (!this.context) throw new Vex$1.RERR("NoCanvasContext", "Can't draw stave without canvas context.");
        ...
        for (var i = 0; i < this.modifiers.length; i++) {
          ...
          if (typeof this.modifiers[i].draw == "function") this.modifiers[i].draw(this, this.getModifierXShift());
        }
      ...
      value: function drawVerticalFixed(x, isDouble) {
        ...
        if (isDouble) this.context.fillRect(x - 3, top_line, 1, bottom_line - top_line + 1);
  ...
  var Tuning = function () {
    ...
    createClass(Tuning, [{
      ...
      value: function setTuning(noteString) {
        if (Tuning.names[noteString]) noteString = Tuning.names[noteString];
        ...
        if (keys.length === 0) throw new Vex$1.RERR("BadArguments", "Invalid tuning string: " + noteString);
      ...
      value: function getValueForString(stringNum) {
        ...
        if (s < 1 || s > this.numStrings) throw new Vex$1.RERR("BadArguments", "String number must be between 1 and " + this.numStrings + ": " + stringNum);
