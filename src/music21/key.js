...
export const key = {};
    ...
    Object.defineProperties(this, {
        'sharps': {
            enumerable: true,
            configurable: true,
            get() { return this._sharps; },
            set(s) { this._alteredPitchesCache = []; this._sharps = s; },
        },
            /**
        ...
        'width': {
            enumerable: true,
            configurable: true,
            get() { return 5 * Math.abs(this.sharps); },
        },
            /**
...
key.KeySignature.prototype.transposePitchFromC = function(p) {
    let transInterval = undefined;
    let transTimes = undefined;
    if (this.sharps == 0) {
