...
//
	     ...
	     */
	                                        ...
	                                        const canvasElement = e.currentTarget;
	                                            let _ = this.findNoteForClick(canvasElement, e),
...
stream.Stream.prototype.playStream = function(options) {
    ...
    const playNext = function(elements, params) {
...
stream.Stream.prototype.setRenderInteraction = function(canvasOrDiv) {
    ...
    const playFunc = (function() { this.playStream(); }).bind(this);
...
stream.Stream.prototype.getScaledXYforCanvas = function(canvas, e) {
    const _ = this.getUnscaledXYforCanvas(canvas, e);
    const xPx = _[0];
    const yPx = _[1];
...
stream.Stream.prototype.findNoteForClick = function(canvas, e, x, y) {
    if (x === undefined || y === undefined) {
        const _ = this.getScaledXYforCanvas(canvas, e);
        x = _[0];
        y = _[1];
    }
...
stream.Stream.prototype.getAccidentalToolbar = function(minAccidental, maxAccidental) {
    ...
    const addAccidental = function(clickedButton, alter) {
            /*
    ...
    const clickFunc = function() { addAccidental(this, $(this).data('alter')); };
    for (let i = minAccidental; i <= maxAccidental; i++) {
        const acc = new music21.pitch.Accidental(i);
