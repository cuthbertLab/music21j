...
define(function(require) {
    ...
    jsonPickle.Converter.prototype.toJSjson = function (pickleIn) {
    ...
    jsonPickle.Converter.prototype.representsFromM21 = function (m21Json) {
    ...
    jsonPickle.Converter.prototype.representsStream = function (m21Json) {
    ...
    jsonPickle.Converter.prototype.knownUnparseables = [
    ...
    jsonPickle.Converter.prototype.skipKeys = ['_elements', ,'_endElements', 'groups', 'py/object', '_fullyQualifiedClasses', 'isFlat', 
    ...
    jsonPickle.Converter.prototype.objFromValue = function (value) {
        var tv = typeof(value);
        if (this.debug) {
    ...
    jsonPickle.Converter.prototype.jsonDictToJSObj = function (m21Json, m21Obj) {
