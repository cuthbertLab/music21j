...
note.Lyric = function(text, number, syllabic, applyRaw, identifier) {
    ...
    Object.defineProperties(this, {
        'identifier': {
            get() { return this._identifier || this._number; },
            set(i) { this._identifier = i; },
            enumerable: true,
        },
        'number': {
            get() { return this._number; },
            set(n) { this._number = n; },
            enumerable: true,
...
note.GeneralNote = function(ql) {
    ...
    Object.defineProperties(this, {
        'quarterLength': {
            get() { return this.duration.quarterLength; },
            set(ql) { this.duration.quarterLength = ql; },
            enumerable: true,
        },
        'lyric': {
            get() {
...
note.Note = function(nn, ql) {
    ...
    Object.defineProperties(this, {
        'name': {
            get() { return this.pitch.name; },
            set(nn) { this.pitch.name = nn; },
            enumerable: true,
        },
        'nameWithOctave': {
            get() { return this.pitch.nameWithOctave; },
            set(nn) { this.pitch.nameWithOctave = nn; },
            enumerable: true,
        },
        'step': {
            get() { return this.pitch.step; },
            set(nn) { this.pitch.step = nn; },
            enumerable: true,
        },
        // no Frequency
        'octave': {
            get() { return this.pitch.octave; },
            set(nn) { this.pitch.octave = nn; },
            enumerable: true,
        },
    });
...
note.Rest.prototype.vexflowNote = function() {
    ...
    if (this.lineShift !== undefined) {
        const p = new music21.pitch.Pitch('B4');
