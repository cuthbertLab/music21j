...
declare module "musicxml/m21ToXml" {
...
declare module "stream/iterator" {
...
declare module "stream/makeNotation" {
...
declare module "musicxml/xmlToM21" {
...
declare module "converter" {
    export function parse(txt: string): import("stream").Score;
}
