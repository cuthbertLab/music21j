...
(function (global, factory) {
  ...
  var OffsetFilter = function (_StreamFilter3) {
      inherits(OffsetFilter, _StreamFilter3);
      createClass(OffsetFilter, null, [{
          key: 'derivationStr',
          get: function get() {
      ...
      function OffsetFilter(offsetStart, offsetEnd) {
          var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
              ...
              includeEndBoundary = _ref$includeEndBounda === undefined ? true : _ref$includeEndBounda,
              _ref$mustFinishInSpan = _ref.mustFinishInSpan,
              mustFinishInSpan = _ref$mustFinishInSpan === undefined ? false : _ref$mustFinishInSpan,
              _ref$mustBeginInSpan = _ref.mustBeginInSpan,
              mustBeginInSpan = _ref$mustBeginInSpan === undefined ? true : _ref$mustBeginInSpan,
              _ref$includeElementsT = _ref.includeElementsThatEndAtStart,
              includeElementsThatEndAtStart = _ref$includeElementsT === undefined ? true : _ref$includeElementsT;

          classCallCheck(this, OffsetFilter);

          var _this6 = possibleConstructorReturn(this, (OffsetFilter.__proto__ || Object.getPrototypeOf(OffsetFilter)).call(this));

          _this6.offsetStart = offsetStart;
          _this6.offsetEnd = offsetEnd;
          _this6.includeEndBoundary = includeEndBoundary;
          _this6.mustFinishInSpan = mustFinishInSpan;
          _this6.mustBeginInSpan = mustBeginInSpan;
          _this6.includeElementsThatEndAtStart = includeElementsThatEndAtStart;
  ...
  var StreamIterator = function () {
      ...
      createClass(StreamIterator, [{
          ...
          value: function getElementsByOffset() {
              ...
              return this.addFilter(new (Function.prototype.bind.apply(OffsetFilter, [null].concat(args)))());
          }
      }, {
          key: 'length',
          get: function get() {
  ...
  var Stream = function (_base$Music21Object) {
      ...
      createClass(Stream, [{
          ...
          value: function offsetMap() {
              ...
              var groups = [];
              if (this.hasVoices()) {
                  $.each(this.getElementsByClass('Voice'), function (i, v) {
          ...
          value: function makeAccidentals() {
              ...
              try {
                  for (var _iterator18 = stepNames[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
                      var stepName = _step18.value;
              ...
              try {
                  for (var _iterator19 = this[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                      ...
                      if (el.pitch !== undefined) {
                          ...
                          try {
                              for (var _iterator20 = el._notes[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                                  var chordNote = _step20.value;
          ...
          value: function noteElementFromScaledX(xPxScaled, allowablePixels, systemIndex, options) {
              ...
              try {
                  for (var _iterator23 = subStream.flat.notesAndRests[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
                      var n = _step23.value;
          ...
          set: function set(newElements) {
              ...
              if (newElements.isStream === true) {
                  ...
                  try {
                      for (var _iterator26 = newElements[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
                          var unused = _step26.value;
