  ...
  */
  var Marcato = function (_DynamicArticulation2) {
      ...
      function Marcato() {
          ...
          LengthArticulation.call(_this11);
  ...
  */
  ...
  miditools.loadSoundfont = function (soundfont, callback) {
      if (miditools.loadedSoundfonts[soundfont] === true) {
          ...
          (function () {
              var _waitThenCall = void 0;
              _waitThenCall = function waitThenCall() {
                  if (miditools.loadedSoundfonts[soundfont] === true) {
                      if (music21.debug) {
                          console.log('other process has finished loading; calling callback');
                      }
                      if (callback !== undefined) {
                          var _instrumentObj = music21.instrument.find(soundfont);
