/**
 * music21j 0.9.0 built on  * 2018-09-23.
...
(function (global, factory) {
      ...
      createClass(Interval, [{
          ...
          value: function transposePitch(p) {
              var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                  ...
                  maxAccidental = _ref$maxAccidental === undefined ? 4 : _ref$maxAccidental;
  ...
  var FilterException = function (_Music21Exception) {
      ...
      function FilterException() {
          classCallCheck(this, FilterException);
          return possibleConstructorReturn(this, (FilterException.__proto__ || Object.getPrototypeOf(FilterException)).apply(this, arguments));
      }
  ...
  var _StopIteration = function _StopIteration() {
      classCallCheck(this, _StopIteration);
  };

  var StopIterationSingleton = new _StopIteration();

  var StreamFilter = function () {
      function StreamFilter() {
          classCallCheck(this, StreamFilter);
      }

      createClass(StreamFilter, [{
          key: 'reset',
  ...
  var IsFilter = function (_StreamFilter) {
      inherits(IsFilter, _StreamFilter);
      createClass(IsFilter, null, [{
          key: 'derivationStr',
          get: function get() {
              return 'is';
          }
      ...
      function IsFilter() {
          ...
          classCallCheck(this, IsFilter);

          var _this2 = possibleConstructorReturn(this, (IsFilter.__proto__ || Object.getPrototypeOf(IsFilter)).call(this));

          if (!Array.isArray(target)) {
              target = [target];
          }
          _this2.target = target;
          _this2.numToFind = target.length;
          return _this2;
      }

      createClass(IsFilter, [{
          key: 'reset',
          value: function reset() {
  ...
  var IsNotFilter = function (_IsFilter) {
      inherits(IsNotFilter, _IsFilter);
      createClass(IsNotFilter, null, [{
          key: 'derivationStr',
          get: function get() {
              return 'IsNot';
          }
      ...
      function IsNotFilter(target) {
          classCallCheck(this, IsNotFilter);

          var _this3 = possibleConstructorReturn(this, (IsNotFilter.__proto__ || Object.getPrototypeOf(IsNotFilter)).call(this, target));

          _this3.numToFind = Number.MAX_SAFE_INTEGER;
          return _this3;
      }

      createClass(IsNotFilter, [{
          key: 'reset',
          value: function reset() {}
      }, {
          key: 'call',
          value: function call(item, iterator) {
              var ret = get(IsNotFilter.prototype.__proto__ || Object.getPrototypeOf(IsNotFilter.prototype), 'call', this).call(this, item, iterator);
  ...
  var ClassFilter = function (_StreamFilter2) {
      inherits(ClassFilter, _StreamFilter2);
      createClass(ClassFilter, null, [{
          key: 'derivationStr',
          get: function get() {
      ...
      function ClassFilter() {
          ...
          classCallCheck(this, ClassFilter);

          var _this4 = possibleConstructorReturn(this, (ClassFilter.__proto__ || Object.getPrototypeOf(ClassFilter)).call(this));

          if (!Array.isArray(classList)) {
              classList = [classList];
          }
          _this4.classList = classList;
          return _this4;
      }
      // TODO: __eq__

      createClass(ClassFilter, [{
          key: 'call',
          value: function call(item, iterator) {
  ...
  var ClassNotFilter = function (_ClassFilter) {
      inherits(ClassNotFilter, _ClassFilter);

      function ClassNotFilter() {
          classCallCheck(this, ClassNotFilter);
          return possibleConstructorReturn(this, (ClassNotFilter.__proto__ || Object.getPrototypeOf(ClassNotFilter)).apply(this, arguments));
      }

      createClass(ClassNotFilter, [{
          key: 'call',
          value: function call(item, iterator) {
              return !get(ClassNotFilter.prototype.__proto__ || Object.getPrototypeOf(ClassNotFilter.prototype), 'call', this).call(this, item, iterator);
          }
      }], [{
          key: 'derivationStr',
          get: function get() {
  ...
  var filters = Object.freeze({
      ...
      StopIterationSingleton: StopIterationSingleton,
      StreamFilter: StreamFilter,
      IsFilter: IsFilter,
      IsNotFilter: IsNotFilter,
      ClassFilter: ClassFilter,
      ClassNotFilter: ClassNotFilter
  });

  // import common from '../common.js';
  var StopIterationSingleton$1 = StopIterationSingleton;

  var StreamIteratorException = function (_StreamException) {
      inherits(StreamIteratorException, _StreamException);

      function StreamIteratorException() {
          classCallCheck(this, StreamIteratorException);
          return possibleConstructorReturn(this, (StreamIteratorException.__proto__ || Object.getPrototypeOf(StreamIteratorException)).apply(this, arguments));
      }
  ...
  var StreamIterator = function () {
      function StreamIterator(srcStream) {
          var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
              ...
              filterList = _ref$filterList === undefined ? [] : _ref$filterList,
              _ref$restoreActiveSit = _ref.restoreActiveSites,
              restoreActiveSites = _ref$restoreActiveSit === undefined ? true : _ref$restoreActiveSit,
              _ref$activeInformatio = _ref.activeInformation,
              activeInformation = _ref$activeInformatio === undefined ? undefined : _ref$activeInformatio,
              _ref$ignoreSorting = _ref.ignoreSorting,
              ignoreSorting = _ref$ignoreSorting === undefined ? false : _ref$ignoreSorting;

          classCallCheck(this, StreamIterator);
      ...
      createClass(StreamIterator, [{
              ...
              return regeneratorRuntime.wrap(function value$(_context) {
                  while (1) {
                      switch (_context.prev = _context.next) {
                          ...
                          case 14:
                              if (!(matches === StopIterationSingleton$1)) {
                                  _context.next = 16;
                                  break;
                              }
          ...
          value: function getElementsByClass(classFilterList) {
              return this.addFilter(new ClassFilter(classFilterList));
          }
      }, {
          key: 'getElementsNotOfClass',
          value: function getElementsNotOfClass(classFilterList) {
              return this.addFilter(new ClassNotFilter(classFilterList));
          }
          ...
          key: 'notes',
          get: function get() {
              return this.addFilter(new ClassFilter('NotRest'));
          }
      }, {
          key: 'notesAndRests',
          get: function get() {
              return this.addFilter(new ClassFilter('GeneralNote'));
          }
      }, {
          key: 'parts',
          get: function get() {
              return this.addFilter(new ClassFilter('Part'));
          }
      }, {
          key: 'spanners',
          get: function get() {
              return this.addFilter(new ClassFilter('Spanner'));
          }
      }, {
          key: 'voices',
          get: function get() {
              return this.addFilter(new ClassFilter('Voice'));
          }
      }]);
      return StreamIterator;
  }();

  var OffsetIterator = function (_StreamIterator) {
      inherits(OffsetIterator, _StreamIterator);

      function OffsetIterator(srcStream) {
          var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
          classCallCheck(this, OffsetIterator);

          var _this2 = possibleConstructorReturn(this, (OffsetIterator.__proto__ || Object.getPrototypeOf(OffsetIterator)).call(this, srcStream, options));

          _this2.nextToYield = [];
          _this2.nextOffsetToYield = undefined;
          return _this2;
      }
      ...
      createClass(OffsetIterator, [{
          ...
          value: regeneratorRuntime.mark(function value() {
              ...
              }, value, this, [[5, 9], [22, 26], [45, 49, 53, 61], [54,, 56, 60]]);
          })
      }, {
          key: 'reset',
          value: function reset() {
              get(OffsetIterator.prototype.__proto__ || Object.getPrototypeOf(OffsetIterator.prototype), 'reset', this).call(this);
              this.nextToYield = [];
  ...
  var RecursiveIterator = function (_StreamIterator2) {
      inherits(RecursiveIterator, _StreamIterator2);
      ...
      function RecursiveIterator(srcStream) {
          var _ref2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
              ...
              streamsOnly = _ref2$streamsOnly === undefined ? false : _ref2$streamsOnly,
              _ref2$includeSelf = _ref2.includeSelf,
              includeSelf = _ref2$includeSelf === undefined ? false : _ref2$includeSelf,
              ignoreSorting = _ref2.ignoreSorting;

          classCallCheck(this, RecursiveIterator);

          var _this3 = possibleConstructorReturn(this, (RecursiveIterator.__proto__ || Object.getPrototypeOf(RecursiveIterator)).call(this, srcStream, {
              filterList: filterList,
          ...
          _this3.returnSelf = includeSelf;
          _this3.includeSelf = includeSelf;
          _this3.ignoreSorting = ignoreSorting;
          _this3.iteratorStartOffsetInHierarchy = 0.0;
          if (streamsOnly) {
      ...
      createClass(RecursiveIterator, [{
          key: 'reset',
          value: function reset() {
              this.returnSelf = this.includeSelf;
              this.childRecursiveIterator = undefined;
              this.activeInformation.lastYielded = undefined;
              get(RecursiveIterator.prototype.__proto__ || Object.getPrototypeOf(RecursiveIterator.prototype), 'reset', this).call(this);
          }
      }, {
          key: Symbol.iterator,
          value: regeneratorRuntime.mark(function value() {
          ...
          value: function matchingElements() {
              ...
              var fe = get(RecursiveIterator.prototype.__proto__ || Object.getPrototypeOf(RecursiveIterator.prototype), 'matchingElements', this).call(this);
  ...
  var iterator = Object.freeze({
      StreamIteratorException: StreamIteratorException,
      ...
      createClass(Stream, [{
          ...
          value: function coreElementsChanged() {
              ...
              if (updateIsFlat) {
                  ...
                  try {
                      for (var _iterator5 = this._elements[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                          var e = _step5.value;
          ...
          value: function recurse() {
              var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                  ...
                  restoreActiveSites = _ref2$restoreActiveSi === undefined ? true : _ref2$restoreActiveSi,
                  _ref2$classFilter = _ref2.classFilter,
                  classFilter = _ref2$classFilter === undefined ? undefined : _ref2$classFilter,
                  _ref2$skipSelf = _ref2.skipSelf,
                  skipSelf = _ref2$skipSelf === undefined ? true : _ref2$skipSelf;

              var includeSelf = !skipSelf;
              var ri = new RecursiveIterator(this, {
                  streamsOnly: streamsOnly,
                  restoreActiveSites: restoreActiveSites,
                  includeSelf: includeSelf
              });
              if (classFilter !== undefined) {
                  ri.addFilter(new ClassFilter(classFilter));
              }
              return ri;
          }
          ...
          value: function insert(offset, el) {
              var _ref3 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
                  ...
                  ignoreSort = _ref3$ignoreSort === undefined ? false : _ref3$ignoreSort,
          ...
          value: function remove(targetOrList) {
              var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                  ...
                  shiftOffsets = _ref4$shiftOffsets === undefined ? false : _ref4$shiftOffsets,
          ...
          value: function replace(target, replacement) {
              var _ref5 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
                  ...
                  recurse = _ref5$recurse === undefined ? false : _ref5$recurse,
          ...
          value: function makeMeasures(options) {
              ...
              if (params.inPlace !== true) {
                  ...
                  try {
                      for (var _iterator8 = post[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                          var _e = _step8.value;
          ...
          value: function containerInHierarchy(el) {
              var _ref6 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
                  ...
                  setActiveSite = _ref6$setActiveSite === undefined ? true : _ref6$setActiveSite;
              ...
              try {
                  for (var _iterator9 = this.recurse({
                      skipSelf: false,
                      streamOnly: true,
          ...
          value: function chordify() {
              var _ref7 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                  ...
                  addTies = _ref7$addTies === undefined ? true : _ref7$addTies,
                  _ref7$addPartIdAsGrou = _ref7.addPartIdAsGroup,
                  addPartIdAsGroup = _ref7$addPartIdAsGrou === undefined ? true : _ref7$addPartIdAsGrou,
                  _ref7$removeRedundant = _ref7.removeRedundantPitches,
                  removeRedundantPitches = _ref7$removeRedundant === undefined ? true : _ref7$removeRedundant,
                  _ref7$toSoundingPitch = _ref7.toSoundingPitch,
                  toSoundingPitch = _ref7$toSoundingPitch === undefined ? true : _ref7$toSoundingPitch;

              var workObj = this;
              var templateStream = void 0;
          ...
          value: function template() {
              var _ref8 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                  ...
                  fillWithRests = _ref8$fillWithRests === undefined ? true : _ref8$fillWithRests,
                  _ref8$removeClasses = _ref8.removeClasses,
                  removeClasses = _ref8$removeClasses === undefined ? [] : _ref8$removeClasses,
                  _ref8$retainVoices = _ref8.retainVoices,
                  retainVoices = _ref8$retainVoices === undefined ? true : _ref8$retainVoices;
              ...
              try {
                  for (var _iterator10 = stream[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
          ...
          value: function cloneEmpty(derivationMethod) {
              var returnObj = this.constructor();
              // TODO(msc): derivation
          ...
          key: 'mergeAttributes',
          value: function mergeAttributes(other) {
              get(Stream.prototype.__proto__ || Object.getPrototypeOf(Stream.prototype), 'mergeAttributes', this).call(this, other);
              var _arr = ['autoSort', 'isSorted', 'definesExplicitSystemBreaks', 'definesEExplicitPageeBreaks', '_atSoundingPitch', '_mutable'];
          ...
          value: function makeBeams(options) {
              ...
              if (this.classes.includes('Measure')) {
                  ...
                  try {
                      for (var _iterator11 = returnObj.getElementsByClass('Measure').elements[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                          var m = _step11.value;
              ...
              try {
                  for (var _iterator12 = mColl[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                      var _m = _step12.value;
                      ...
                      try {
                          for (var _iterator13 = noteStream[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
          ...
          value: function getElementsByOffset(offsetStart, offsetEnd) {
              var _ref10 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
                  ...
                  includeEndBoundary = _ref10$includeEndBoun === undefined ? true : _ref10$includeEndBoun,
                  _ref10$mustFinishInSp = _ref10.mustFinishInSpan,
                  mustFinishInSpan = _ref10$mustFinishInSp === undefined ? false : _ref10$mustFinishInSp,
                  _ref10$mustBeginInSpa = _ref10.mustBeginInSpan,
                  mustBeginInSpan = _ref10$mustBeginInSpa === undefined ? true : _ref10$mustBeginInSpa,
                  _ref10$includeElement = _ref10.includeElementsThatEndAtStart,
                  includeElementsThatEndAtStart = _ref10$includeElement === undefined ? true : _ref10$includeElement,
                  _ref10$classList = _ref10.classList,
                  classList = _ref10$classList === undefined ? undefined : _ref10$classList;

              var s = this;
              if (classList !== undefined) {
                  s = this.getElementsByClass(classList);
              }
              var zeroLengthSearch = false;
              ...
              var isElementOffsetInRange = function isElementOffsetInRange(e, offset) {
                  if (offset > offsetEnd) {
              ...
              try {
                  for (var _iterator17 = s[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
                      var e = _step17.value;
          ...
          value: function playingWhenAttacked(el, elStream) {
              ...
              var otherElements = this.getElementsByOffset(elOffset, elOffset, { mustBeginInSpan: false });
              if (otherElements.length === 0) {
                  ...
                  try {
                      for (var _iterator18 = otherElements[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
          ...
          value: function makeAccidentals() {
              ...
              try {
                  for (var _iterator19 = stepNames[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                      var stepName = _step19.value;
              ...
              try {
                  for (var _iterator20 = this[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                      ...
                      if (el.pitch !== undefined) {
                          ...
                          try {
                              for (var _iterator21 = el._notes[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
                                  var chordNote = _step21.value;
          ...
          set: function set(newElements) {
              ...
              if (newElements.isStream === true) {
                  ...
                  try {
                      for (var _iterator27 = newElements[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
                          var unused = _step27.value;
  ...
  var Part = function (_Stream3) {
      ...
      createClass(Part, [{
          ...
          value: function setSubstreamRenderOptions() {
              ...
              try {
                  for (var _iterator30 = this.getElementsByClass('Measure')[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
                      var m = _step30.value;
          ...
          value: function findNoteForClick(svg, e) {
              ...
              if (debug) {
                  console.log('this.estimateStreamHeight(): ' + this.estimateStreamHeight() + ' / $(svg).height(): ' + $(svg).height());
              }
              var systemPadding = this.renderOptions.systemPadding;
              if (systemPadding === undefined) {
                  systemPadding = this.renderOptions.naiveSystemPadding;
          ...
          value: function getStreamFromScaledXandSystemIndex(xPxScaled, systemIndex) {
              ...
              try {
                  for (var _iterator31 = measures[Symbol.iterator](), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
                      var m = _step31.value;
      ...
      createClass(Score, [{
          ...
          value: function evenPartMeasureSpacing() {
              var _ref11 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
                  ...
                  setLeft = _ref11$setLeft === undefined ? true : _ref11$setLeft;
